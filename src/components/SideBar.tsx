...
import { setDarkMode } from '../service/DarkModeSlice'
...
export default function Sidebar() {
  ...
  return (
    ...
    <aside className='dark:bg-slate-900  bg-slate-50'>
      ...
      <div className={`fixed -z-50 top-0 left-0 touch-none transition-all -translate-x-full ${showSidebar ? 'translate-x-0 z-50' : ''} bg-slate-50  dark:bg-gray-800 `}>
          ...
          <div className="w-72 h-screen">
            <div className="flex items-center justify-start mx-6 mt-10">
              ...
              <Link to='/' className="block w-full  relative">
                <img alt="profil" src={img1} className="mx-auto hover:outline hover:outline-4 transition-all hover:outline-red-400 object-cover rounded-full h-20 w-20 " />
              </Link>

            </div>
            <div className="flex items-center justify-center mt-3">
              <h1 className='text-2xl text-opacity-60 text-gray-800 dark:text-white'>username</h1>
            </div>
            <nav className="mt-10 px-6 ">
              ...
              <Link to='/' className="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-100 rounded-lg bg-gray-100 dark:bg-gray-600" >
                <svg width="20" height="20" fill="currentColor" className="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="absolute bottom-0 my-10">
              <Link to='/' className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors duration-200 flex items-center py-2 px-8" >
