                ...
                <div className="container m-auto px-6 text-gray-600 dark:text-slate-50 md:px-12 xl:px-6">
                    <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                        ...
                        <div className="md:7/12 lg:w-6/12">
                            <h2 className="text-2xl text-gray-900 dark:text-slate-50 font-bold md:text-4xl">YT Downloader is online youtube video downloader service built with react js bt <a href='https://ahmadsoran.com' rel="noreferrer" referrerPolicy='no-referrer' target='_blank' className='text-indigo-600 underline'>Ahmad Soran</a></h2>
